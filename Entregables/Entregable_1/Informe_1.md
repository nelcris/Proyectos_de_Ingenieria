...
Según los datos obtenidos, medir la concentración de monóxido de carbono (CO) en los Estados Unidos es crucial para proteger la salud pública y el medio ambiente. En cuanto a los valores de CO permitidos, la Agencia de Protección Ambiental (EPA) establece un estándar nacional de calidad del aire para CO de 9 partes por millón (ppm) sobre un promedio de 8 horas y 35 ppm sobre un promedio de 1 hora .  Si bien es cierto los datos que se obtuvieron en los años 2022 y 2023 la EPA solo considera datos exteriores (indica la presencia de CO en el aire) por un promedio de 8 horas, evidentemente los resultados que se obtuvieron son mucho menores que 9 ppm; sin embargo la EPA no  mide las concentraciones de interiores ya que el CO en interiores generalmente proviene de fuentes como calentadores de gas, estufas, chimeneas, generadores portátiles y vehículos que funcionan en espacios cerrados;  estos generalmente son los que están en mayor concentración donde se indica que los niveles promedio en las casas sin estufas de gas varían de 0,5 a 5 partes por millón (ppm). Los niveles cercanos a las estufas de gas ajustados correctamente suelen ser de 5 a 15 ppm y aquellos cerca de estufas poco ajustadas pueden ser de 30 ppm o más. Entonces como grupo entendemos que el problema en sí no es la presencia de CO en el exterior, si no en el interior ya que contrastando con los valores de EPA admisibles los valores de este último exceden los valores permitidos todo ello teniendo como consecuencia malestares e incluso muerte de personas.
...
[^3]:“Monóxido de carbono | US EPA”. US EPA. Accedido el 25 de agosto de 2024. [En línea]. Disponible: https://espanol.epa.gov/cai/monoxido-de-carbono
[^4]“Fatal Weather-Related Carbon Monoxide Poisonings in the United States”. AMETSOC. Accedido el 25 de agosto de 2024. [En línea]. Disponible: https://doi.org/10.1175/WCAS-D-21-0130
