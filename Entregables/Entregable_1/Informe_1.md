...
## **Discusión**
 El análisis comparativo de las correlaciones entre las variables de concentración máxima diaria de CO en 8 horas, el Índice de Calidad del Aire (AQI) diario y el número de observaciones diarias para los años 2022 y 2023 revelan varios hallazgos importantes, Pues la consistencia en la relación entre el monóxido de carbono y la calidad del aire en Nevada durante los años estudiados. La correlación casi perfecta entre la concentración de CO y el AQI sugiere que el control de las emisiones de CO debería ser una prioridad en las políticas ambientales para mejorar la calidad del aire. Por otro lado, las correlaciones débiles con el número de observaciones diarias indican que factores externos o el propio método de recolección de datos pueden estar influyendo en la falta de relación significativa con el AQI y la concentración de CO.
